      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          ...
          <div className="flex items-start max-w-6xl mx-auto mt-16">
            <button className="animate-pulse hidden p-2 text-blue-600 transition-colors duration-300 border rounded-full rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 lg:block hover:bg-blue-200">
              <svg
