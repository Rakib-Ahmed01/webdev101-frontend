import onlineLearning from '../assets/images/online-learning2.jpg';
            ...
            <div className="w-full space-y-12 lg:w-1/2 ">
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                    Skilled, Helpful Instructors
                  </h1>

                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    We have best instructors that you can find all over the
                    internet. Our instructors are skilled, helpful and
                    supporting...
                  </p>
                </div>
              </div>
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    We provide 24/7 support. Whenever you will face problem we
                    will get your back...
                  </p>
                </div>
              </div>
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    All courses are in minimal prices. We want to ensure that
                    everyone can get best leagning and guidence at a low
                    price...
                  </p>
                </div>
              </div>
